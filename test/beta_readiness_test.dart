...
void main() {
  ...
  group(
    'Product Stabilization / Device QA / Onboarding / UI / Beta (v0.36-v0.57)',
    () {
      ...
      test('beta-next output', () async {
        ...
        expect(result.output, contains('v0.58 Git Perl Setup Follow-up / Build Readiness'));
      });
      ...
      test('bug-report output omits unsafe env dump', () async {
        ...
        expect(result.output, contains('Termode version: v0.57'));
      ...
      test('qa-report output is compact and safe', () async {
        ...
        expect(result.output, contains('Termode v0.57'));
      ...
      test('docs are present', () {
        ...
        expect(File('README.md').readAsStringSync(), contains('v0.57'));
        expect(

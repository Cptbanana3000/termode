...
void main() {
  ...
  group(
    'Product Stabilization / Device QA / Onboarding / UI / Beta (v0.36-v0.52)',
    () {
      ...
      test('beta-next output', () async {
        ...
        expect(result.output, contains('v0.53 Git Source + Dependency'));
      });
      ...
      test('bug-report output omits unsafe env dump', () async {
        ...
        expect(result.output, contains('Termode version: v0.52'));
      ...
      test('qa-report output is compact and safe', () async {
        ...
        expect(result.output, contains('Termode v0.52'));
      ...
      test('docs are present', () {
        ...
        expect(File('README.md').readAsStringSync(), contains('v0.52'));
        expect(
